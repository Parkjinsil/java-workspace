...
public class B_InDecrease {
	 ...
	 * - 값(증감 연산자) : 후의 연산으로 먼저 다른 연산을 수행하고 증감 연산을 수행
	 * 
	 */
...
//		b.method1();
	...
	public void method2() {
		...
		System.out.println(number1++);   // number1 : 10(11)
		System.out.println((++number1)+(number2++));   // 32, number1 = 12, number2 = 20(21)
		System.out.println((number1++) + (--number2) + (--number3));   // 61, number : 12(13), number2 : 20, number3 : 29
