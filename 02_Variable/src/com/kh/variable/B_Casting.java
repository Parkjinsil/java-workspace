...
//		b.autoCasting();
	...
	public void autoCasting() {
		...
		//byte, short 타입의 데이터는 연산시 무조건 int 타입으로 변환 후 처리한다.
		int result2 = b + s;
	...
	public void casting() {
		...
		// char <-> int : 각 문자들마다 고유한 숫자가 지정되어 있기 때문에 쌍방향으로 형 변환 가능
		// char는 음수값 저장 불가 -> 값의 범위가 0~65535
        int num = 'A'; // 지정되어 있어서 자동 형 변환 가능
