 ...
 * - 기본 자료형으로 사용해도 되지만 해당 기본 타입을 객체로 취급해서 처리해야 하는 경우 사용 (ex. Integer.parseInt)
 * - Boxing : 기본 자료형을 Wrapper 클래스로 포장해주는 거
...
//		b.method1();
	...
	public void method1() {
		...
		System.out.println("dNum2 == double1 : "+(dNum2 == double2));   // true
	    ...
	    // 자바 1.9 버전 이후로는 Boxing, UnBoxing 기능을 안쓰도록 Deprecated 되어있음
