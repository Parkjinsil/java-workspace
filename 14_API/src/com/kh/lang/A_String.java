...
//		a.method4();
	...
	public void method1() {
		String str1 = "hello";
		String str2 = "hello"; 
		String str3 = new String("hello");  // 주소값 담김
		String str4 = new String("hello");  // 주소값 담김
		...
		System.out.println("str4.toString() : "+str3.toString());
		...
		System.out.println("str1.hashCode() : "+str1.hashCode()); // true (값 비교)
		...
		System.out.println("str3 : "+System.identityHashCode(str3)); // 실제 주소값
	...
	public void method2() {
		...
		// 3. substring(int beginIndex) : String - 문자열의 beginIndex 위치에서부터 끝까지 문자열을 새로 생성해서 리턴
